...
> **Note:** this is my fork of [Main GhostESP](https://github.com/jaylikesbunda/Ghost_ESP) project intented for implementing fixes to bugs without destroying the main repo. If changes are aprroved by maintainers & merged, you'll find the upstream in main repo.
